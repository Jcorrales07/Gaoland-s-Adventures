...
{
	//Arte // 0 - 4
	questions.push_back("Uno de los siguientes personajes fue el encargado de pintar la capilla Sixtina: ");
	questions.push_back("Genio del renacimiento que esculpió el Moisés, el David y la Pietá: ");
	questions.push_back("Durante el renacimiento el estilo artístico que impregnó el arte, la filosofía, la pintura escritura fue el: ");
	questions.push_back("Durante el renacimiento surge una nueva visión del hombre,\n que se vio reflejada en el arte, en la y\n en las ciencias sociales y humanas, a lo que se denomina : ");
	questions.push_back("Cuatro genios del renacimiento (Leonardo, Donatello, Rafael y Michelangelo) han sido llevados a la pantalla en los comics de :");
}
...
{
	//Politica // 0 - 4
	questions.push_back("Durante el renacimiento, el modelo de gobierno es uno de los siguientes: ");
	questions.push_back("De los siguientes acontecimientos, selecciones el que inicia el período moderno: ");
	questions.push_back("Durante el siglo XV, la sociedad se estratifica en tres estamentos definidos: ");
	questions.push_back("Aparece el realismo político, que se basaba en un orden establecido, explicación de un sistema y recomendaciones de como gobernar : ");
	questions.push_back("Terminada la edad media, en el contexto de la política resulta que: ");
}
...
{
	//Ciencia // 0 -4
	questions.push_back("Entre los siguientes renacentistas seleccione, uno de los precursoresfilósofo-científico del heliocentrismo (teoría que afirma que el sol es el centro del universo) : ");
	questions.push_back("El método científico se introduce por el interés de tres filósofos. Entre los siguientes uno de los mencionados no es precursor del método científico : ");
	questions.push_back("Es uno de los precursores del pensamiento Moderno: ");
	questions.push_back("De los siguientes filósofos niega el geocentrismo (teoría que afirma que el centro de nuestro sistema solar es la tierra) : ");
	questions.push_back("Uno de los inventos que suscitó un conocimiento ilimitado, fue el de Gutenberg: ");
}
...
{
	//Historia // 0 - 4
	questions.push_back("Después del feudalismo medieval acudimos al surgimiento de una nueva clase social conocida como la: ");
	questions.push_back("El renacimiento supone una época de absolutismo y nacionalismos, como el nacimiento de fuertes monarquías europeas centralizadas como : ");
	questions.push_back("Antes de la consolidación del estado moderno, Italia estuvo divida en pequeñas ciudades-estado normalmente enfrentadas entre si, como es el caso de : ");
	questions.push_back("La toma de Constantinopla supone un bloqueo comercial entre Europa y Asia (la ruta de la seda) y ocurrió en lo que hoy es actualmente : ");
	questions.push_back("Resurge el interés por Grecia y Roma, junto al declive del sistema feudal, el crecimiento del comercio e innovaciones entre las que mencionamos : ");
}
